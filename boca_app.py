...
def criar_e_upar_video(imagem_bytes, post_id):
    ...
    try:
        ...
        print(f"  - [ID: {post_id}] Vídeo criado com sucesso.")

        print(f"☁️ [ID: {post_id}] Fazendo upload para o Cloudinary...")
        ...
        print(f"❌ [ID: {post_id}] ERRO na criação ou upload do vídeo: {e}")
        return None
    finally:
